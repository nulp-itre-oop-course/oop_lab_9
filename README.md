...
|----|-------------------------------|--------------------------------------------------|
|  1 | Канал передавання даних       | Радіоканал, оптоволоконний канал                 |
|  2 | Транзистор                    | Біполярний транзистор, польовий транзистор       |
|  3 | Радіостанція                  | Базова станція, портативна рація                 |
|  4 | Прилад                        | Мультиметр, осцилограф                           |
|  5 | Сенсор                        | Датчик температури, датчик світла                |
|  6 | Електронна плата              | Макетна плата, друкована плата                   |
|  7 | Контролер                     | Мікроконтролер, програмований логічний контролер |
|  8 | Електромагнітний випромінювач | Світлодіод, лазер                                |
|  9 | Провідник сигналів            | Коаксіальний кабель, оптоволокно                 |
| 10 | Мікросхема                    | Логічна мікросхема, пам’ять                      |
| 11 | Антена                        | Всеспрямована антена, антена направленої дії     |
| 12 | Джерело живлення              | Павербанк, бензиновий/дизель генератор           |
| 13 | Фільтр                        | Фільтр нижніх частот, смуговий фільтр            |
| 14 | Напівпровідниковий діод       | Стабілітрон, тунельний діод                      |
| 15 | Мобільний телефон             | Кнопковий телефон, смартфон                      |
| 16 | Двигун                        | Серводвигун, кроковий двигун                     |
| 17 | Перетворювач напруги          | Підсилювач напруги, послаблювач напруги          |
| 18 | Бездротова технологія         | WiFi, Bluetooth                                  |
| 19 | Дисплей                       | Рідкокристалічний дисплей, OLED-дисплей          |
| 20 | Комунікаційний пристрій       | Маршрутизатор, комутатор                         |
| 21 | Операційна система            | Android, iOS                                     |
| 22 | Звуковий пристрій             | Мікрофон, динамік                                |
| 23 | Оптичний компонент            | Світлодіод, фоторезистор                         |
| 24 | Електронний компонент         | Пасивний компонент, активний компонент           |
| 25 | Супутниковий термінал         | Термінал для зв’язку, термінал для телебачення   |
| 26 | Реле                          | Електромагнітне реле, твердотільне реле          |
| 27 | Зчитувач інформації           | Сканер штрих-коду, RFID-зчитувач                 |
| 28 | Резонатор                     | Кварцовий резонатор, керамічний резонатор        |
| 29 | Акумулятор                    | Літій-іонний, свинцево-кислотний                 |
| 30 | Датчик руху                   | Інфрачервоний датчик, радарний датчик            |